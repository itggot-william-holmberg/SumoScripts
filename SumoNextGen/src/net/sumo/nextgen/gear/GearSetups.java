...
public enum GearSetups {
	...
	STARTER_MAGE_SETUP(GenItem.leatherBody.getItemName(), GenItem.leatherChaps.getItemName(), GenItem.coif.getItemName(), GenItem.leatherVambs.getItemName(), GenItem.shortbow.getItemName(), GenItem.greenCape.getItemName(), GenItem.leatherBoots.getItemName(), GenItem.amuletOfPower.getItemName(), GenItem.diamondRing.getItemName(), GenItem.bronzeArrows.getItemName()),
