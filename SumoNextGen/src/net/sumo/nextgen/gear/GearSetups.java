...
public enum GearSetups {
	...
	STARTER_MAGE_SETUP(GenItem.blueWizardRobe.getItemName(), GenItem.shadeRobe.getItemName(), GenItem.wizardHat.getItemName(), GenItem.leatherVambs.getItemName(), GenItem.airStaff.getItemName(), GenItem.greenCape.getItemName(), GenItem.leatherBoots.getItemName(), GenItem.amuletOfPower.getItemName(), GenItem.diamondRing.getItemName(), GenItem.bronzeArrows.getItemName()),
	...
	THIRTHY_RANGE_SETUP(GenItem.leatherBody.getItemName(), GenItem.studdedChaps.getItemName(), GenItem.coif.getItemName(), GenItem.leatherVambs.getItemName(), GenItem.mapleShortbow.getItemName(), GenItem.greenCape.getItemName(), GenItem.leatherBoots.getItemName(), GenItem.amuletOfPower.getItemName(), GenItem.diamondRing.getItemName(), GenItem.bronzeArrows.getItemName());
